        ...
        <div className="w-full max-w-[400px] z-10">
          ...
          <div className="bg-surface-container-lowest border border-[#e8e2d9] rounded-xl p-6 md:p-8 shadow-sm">
            ...
            <div className="flex flex-col items-center mb-8">
              <div className="w-12 h-12 bg-primary-container/10 rounded-full flex items-center justify-center mb-2">
                <span className="material-symbols-outlined text-primary text-3xl" data-icon="ecg_heart">ecg_heart</span>
              </div>
              <h2 className="font-semibold text-2xl text-on-surface">NutriSense AI</h2>
              <p className="text-sm text-on-surface-variant text-center mt-1">Log in to track your metabolic health</p>
            </div>
            ...
            <div className="mt-8 text-center">
              <p className="text-sm text-on-surface-variant">
                Don&apos;t have an account? <Link className="text-[#e85d3a] font-semibold hover:underline" href="/signup">Create an account</Link>
              </p>
            </div>
          </div>
        </div>
